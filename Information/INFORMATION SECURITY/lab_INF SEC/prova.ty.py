...
#dont delete the follow piece OF COMMENTS

'''
u = 0x08DF78BA #problem with this hex - in slides zero paddling applied
u = hexToBinary(u)
...
print("hacked key of  :"+ str(k_hacked))
...
test=[0x352E9951,0x4D1E7AC0,0X08DF78BA,0X3B0145A6,0XD8249EFC]  #test case plaintest of professor
for i in range(0,len(test)):
    u = hexToBinary(test[i])
    u = u.zfill(lu) #zfill func to equalize current size of u to lu
    u = list(u)
    u = [int(i) for i in u] 
    #print (u)
